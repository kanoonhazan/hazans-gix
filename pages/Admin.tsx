...
const Admin: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-richBlack text-stone font-sans relative">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                    ...
                    <Button variant="primary" icon onClick={handleCreate}>
                        ...
                        {projects.map(project => (
                            <div key={project.id} className="bg-darkGreen/30 border border-darkGreen p-6 rounded-2xl flex items-center justify-between group hover:border-caribbeanGreen/30 transition-colors">
                                ...
                                <div className="flex items-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <button onClick={() => handleEdit(project)} className="p-2 text-caribbeanGreen hover:bg-caribbeanGreen/10 rounded-lg transition-colors">
